...
Schedule::command('queue:work --queue=invoices,products,bulk-update,empty-unique-ids,unique-ids-sync,category,woocommerce,woocommerce-update,woocommerce-sync,woocommerce-insert,product-processing,product-coordination,product-sync-all,default --tries=3 --max-jobs=100 --timeout=900 --stop-when-empty')
    ->everyMinute()
    ->withoutOverlapping()
    ->onOneServer()
