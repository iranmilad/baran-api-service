...
Schedule::command('queue:work --queue=invoices,products,product-sync-all,product-processing,empty-unique-ids,product-changes,bulk-update,unique-ids-sync,category,product-coordination,woocommerce,woocommerce-sync,woocommerce-insert,woocommerce-update,default --tries=3 --max-jobs=100 --timeout=900 --stop-when-empty')
    ->everyMinute()
    ->withoutOverlapping()
    ->onOneServer()
